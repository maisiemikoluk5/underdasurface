...
label oh_no:
    ...
    n "You don’t want to cause a scene in public, and you most certaintly don't want to make him look bad."
...
label saladt:
    ...
    n "In fact, it's still your favourite."
